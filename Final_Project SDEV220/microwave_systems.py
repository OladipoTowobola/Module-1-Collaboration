...
class MicrowaveEngine:
    ...
    def start_cooking(self, time_seconds, power_level=100, stage=CookingStage.COOK):
        ...
        # If paused (remaining_time > 0), resume instead of restart
        ...
        # Otherwise, start new cooking session
        self.is_running = True
...
class UserInterface:
    ...
    def create_widgets(self):
        ...
        self.stop_btn = ttk.Button(self.control_frame, text="STOP/RESET", 
                                  command=self.stop_cooking, width=15)
        self.pause_btn = ttk.Button(self.control_frame, text="PAUSE/RESUME", 
